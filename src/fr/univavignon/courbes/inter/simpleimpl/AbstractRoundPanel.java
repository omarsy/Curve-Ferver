...
{	/** Numéro de série de la classe */
	...
	/**
	 * L'ensemble des informations sur l'elimination durant toute la partie
	 */
	protected Vector<Integer[]> partieliminated = new Vector<Integer[]>();
	/**
...
//		System.exit(0);
	...
	{	eliminatedBy[i] = snakes[i].eliminatedBy;
		System.out.print(" "+eliminatedBy[i]+"  "+i);
	}
	this.partieliminated.addElement(eliminatedBy);
	System.out.println();
}
}
