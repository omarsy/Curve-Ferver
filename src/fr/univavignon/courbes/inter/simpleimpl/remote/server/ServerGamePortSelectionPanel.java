...
{	/** Numéro de série de la classe */
	...
	/** Boolean representant si la partie est publique ou non***/
...
//		ipTextField.setEditable(false);
	...
	{	String portStr = portTextField.getText();
		...
		mainWindow.serverCom.setPort(port);
		  if (publicc)
		   {
			   mainWindow.displayPanel(PanelName.SERVER_CENTRAL_GAME_LOCAL_PLAYER_SELECTION);   
		   }
		   else
