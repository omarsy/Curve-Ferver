...
{	/** Numéro de série */
	...
	if(BDD.PlayerConnecte(this.selectedProfiles.get(0).player.profile))
	mainWindow.displayPanel(PanelName.CLIENT_SERVEUR_SELECTION);
	else
		JOptionPane.showMessageDialog(mainWindow, 
				"<html>Impossible de nous connecter au central" +
				"<br/>Erreur de Login ou de connexion</html>");
