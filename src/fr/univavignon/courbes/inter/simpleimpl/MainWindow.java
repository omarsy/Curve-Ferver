...
import fr.univavignon.courbes.inter.central.ClientServerSelectionPanel;
import fr.univavignon.courbes.inter.central.ServerCentralGameLocalPlayerSelectionPanel;
import fr.univavignon.courbes.inter.central.ServerCentralGameRemotePlayerSelectionPanel;
import fr.univavignon.courbes.inter.central.ServerCentralGameRoundPanel;
...
import fr.univavignon.courbes.inter.stats.StatPanel;
...
{	/** Numéro de série de la classe */
	...
	/** Nom du jeu */
	private static final String GAME_NAME = "CURVE";
	/** Version du jeu */
	private static final String GAME_VERSION = "1";
	/** L'id de la partie deroulant cote serveur*/
	public int idPartie; // ajouter
	/**
	...
	{	/** Menu principal */
		...
		SERVER_GAME_PLAY,
		/** Sélection des joueurs locaux au serveur pour une partie réseau  connecte au central */
		SERVER_CENTRAL_GAME_LOCAL_PLAYER_SELECTION,
		/** Sélection des joueurs distants pour une partie réseau connecte au central */
		SERVER_CENTRAL_GAME_REMOTE_PLAYER_SELECTION,
		...
		CLIENT_GAME_PLAY,
		/**
		 * chercher les serveurs disponible cote client central
		 */
		CLIENT_SERVEUR_SELECTION,
		/** Aire de jeu d'une partie réseau côté serveur connecte au central  */
		SERVER_CENTRAL_GAME_PLAY,
		/** Liste des profils */
		PROFILE_LIST,
	...
	{	getContentPane().remove(currentPanel);
		...
		{	// menus
			...
			case STATISTICS:
				...
				break;
				//ajout
			case SERVER_CENTRAL_GAME_LOCAL_PLAYER_SELECTION:
				currentPanel = new ServerCentralGameLocalPlayerSelectionPanel(this);
				break;
		//ajout
			case SERVER_CENTRAL_GAME_REMOTE_PLAYER_SELECTION:
				currentPanel = new ServerCentralGameRemotePlayerSelectionPanel(this);
				break;
			//ajout
			case SERVER_CENTRAL_GAME_PLAY:
				currentPanel = new ServerCentralGameRoundPanel(this);
				((ServerCentralGameRoundPanel)currentPanel).start();
				break;
				//ajouter par Omar Sy
			case CLIENT_SERVEUR_SELECTION:
				currentPanel = new ClientServerSelectionPanel(this);
				break;
		}
